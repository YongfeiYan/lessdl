...
from lessdl.module.transformer import TransformerEncoderLayer
def testinit(module):
...
# from lessdl.task import get_task_cls
from lessdl.model import get_arch_arch, get_model_cls
...
def compare_decoder(model, fmodel):
    ...
    from lessdl.model.transformer import generate_square_subsequent_mask
